> **[getHarshOnline/gastown](https://github.com/getHarshOnline/gastown)** — fork of the canonical [gastownhall/gastown](https://github.com/gastownhall/gastown) repository maintained on the **`gho`** branch with reviewed upstream merges. This branch preserves fork identity and owner-selected additions; its availability does not by itself establish JARVIS admission, provider selection, deployment, or activation.
